...
import { Github, Download, ExternalLink, Box } from "lucide-react";
             ...
             >
                <div className="relative group">
                  ...
                  <a 
                    ...
                    className="relative block bg-[#0F0F0F] rounded-xl border border-white/10 p-8 flex flex-col justify-between transition-transform duration-300 hover:-translate-y-1 cursor-pointer"
                  >
                     <div className="flex justify-between items-start mb-4">
                        <div className="p-3 rounded-lg bg-purple-500/10 text-purple-500 transition-colors">
                           <Github className="w-8 h-8" />
                        </div>
                        <ExternalLink className="w-5 h-5 text-white/20 group-hover:text-white/60" />
                     </div>
                     <div>
                        <h3 className="text-2xl font-semibold mb-2 text-white">View on GitHub</h3>
                        <p className="text-sm text-white/50 font-mono">Source code, issues, and contributions</p>
                     </div>
                  </a>
                </div>
             </motion.div>

             {/* Docker Hub and ZIP Download - Side by Side */}
                ...
                >
                   <div className="h-full relative group">
                     ...
                     <a 
                       ...
                       className="relative block h-full bg-[#0F0F0F] rounded-xl border border-white/10 p-6 flex flex-col justify-between transition-transform duration-300 hover:-translate-y-1 cursor-pointer"
                     >
                        <div className="flex justify-between items-start mb-4">
                           <div className="p-3 rounded-lg bg-emerald-500/10 text-emerald-500 transition-colors">
